 ...
 */
public class EdibleItem extends Item implements Edible, Serializable {

    private static final Integer NUMBER_OF_CALORIES_PER_KILO = 500;
     ...
     */
    public EdibleItem(String name, long id, Category category, BigDecimal width, BigDecimal height, BigDecimal length,
